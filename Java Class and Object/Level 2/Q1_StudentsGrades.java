public class Q1_StudentsGrades {
    String name;
	String rollNumber;
	double[] marks;
	...
	Q1_StudentsGrades(String name,String rollNumber,double[] marks) {
		this.name=name;
	...
	public static void main(String[] args) {
		...
		Q1_StudentsGrades student1 = new Q1_StudentsGrades("Thamarai", "ECE001", mark1);
		Q1_StudentsGrades student2 = new Q1_StudentsGrades("Kannan","CSC002",mark2);
